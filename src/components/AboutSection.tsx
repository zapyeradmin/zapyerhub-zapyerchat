...
const AboutSection = () => {
  ...
  return <section id="about" className="py-20 bg-card/30 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-full min-h-[400px] fade-in-right">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-primary/20">
              <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070&auto=format&fit=crop" alt="Equipe colaborando em um ambiente tecnológico" className="w-full h-full object-cover" onError={e => {
